...
python train.py --restore_step 500000 -p config/Blizzard/preprocess.yaml -m config/Blizzard/model.yaml -t config/Blizzard/train.yaml 
echo training complete

rsync -aP /ssd_scratch/cvit/neha/output/ckpt/Blizzard1/900000* ada:/share3/neha.sherin/Blizzard
